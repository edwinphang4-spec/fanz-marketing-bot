...
const TEXT_ZONE = { top: TEXT_ZONE_TOP, bottom: 1 };
...
module.exports = { buildReferenceImagePrompt, deriveCreativeDirection, deriveImageText, pickLogoSeries, TEXT_ZONE, TEXT_ZONE_TOP };
