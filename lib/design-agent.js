        ...
        messages: [
          {
            ...
            content:
              ...
              'Never repeat the same claim across HEADLINE and SUBHEADING — they must carry different ' +
              'information (e.g. do not put the warranty in both).\n' +
 ...
 */
async function buildReferenceImagePrompt(row, template, productName, brandVoice, productMeta, brandColors) {
