        ...
        messages: [
          {
            ...
            content:
              ...
              'CTA: 2-4 words. Compress THIS post\'s own closing line into a button — every post ' +
              'ends with its own invitation, so shorten that one rather than reaching for a stock ' +
              'phrase. It must be a conversational invitation to talk to Fanz, not "Shop Now" or ' +
              '"Get Yours Today", and not the same wording you would use for a different post.\n' +
