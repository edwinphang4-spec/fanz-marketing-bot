...
class StringRegExp extends RegExp {
  includes(needle) {
    return this.source.includes(needle);
  }
}
...
function buildCopywritingPrompt(topic, pillar) {
  ...
  return `You are a senior social media copywriter for Fanz Sdn Bhd, a Malaysian ceiling fan and air cooler brand.
